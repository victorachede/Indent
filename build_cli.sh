...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/Indent/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Indent/indent-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Indent/indent/releases"
fi
